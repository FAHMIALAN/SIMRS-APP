...
<div class="max-w-4xl mx-auto">
    <div class="card p-0 mb-8" id="print-area">
        <!-- Receipt Header -->
        <div class="p-10 border-b-2 border-dashed border-slate-200">
            ...
            <div class="mt-10 grid grid-cols-1 sm:grid-cols-4 gap-8">
                <div class="space-y-1">
                    <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest block">Nomor RM</span>
                    <span class="text-sm font-bold text-slate-800"><?= $peresepan['nomor_rm'] ?></span>
                </div>
                <div class="space-y-1">
                ...
                <div class="space-y-1">
                    ...
                    <span class="text-sm font-bold text-slate-800 italic text-blue-600"><?= $peresepan['nama_dokter'] ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="p-10">
            ...
            <div class="mt-10 pt-10 border-t-2 border-slate-100 flex flex-col md:flex-row justify-between items-start gap-8">
                <!-- Payment Instructions -->
                <div class="flex-1 p-6 bg-blue-50/50 rounded-2xl border border-blue-100 no-print">
                    <h4 class="text-sm font-bold text-blue-800 mb-3 flex items-center gap-2">
                        <i class="fas fa-info-circle"></i> Instruksi Pembayaran
                    </h4>
                    <ol class="text-[11px] text-slate-600 space-y-2 list-decimal list-inside font-medium">
                        <li>Tunjukkan struk ini ke bagian Kasir.</li>
                        <li>Lakukan pelunasan sesuai total tagihan.</li>
                        <li>Bawa bukti bayar ke Apotek/Farmasi untuk ambil obat.</li>
                    </ol>
                </div>
                ...
                <div class="w-full max-w-[280px] space-y-4">
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-slate-100">
                        ...
                        <span class="text-2xl font-black text-emerald-600">Rp <?= number_format($peresepan['total_harga'], 0, ',', '.') ?></span>
                    </div>
                </div>
            </div>
            
            <div class="mt-16 text-center">
                <p class="text-[10px] text-slate-400 font-medium italic">Resep ini adalah dokumen sah digital dari SIMRS Pro System.</p>
            </div>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center gap-4 no-print">
        ...
        <a href="<?= base_url('user/dashboard') ?>" class="px-8 py-3 bg-slate-200 hover:bg-slate-300 text-slate-700 font-bold rounded-2xl transition-all flex items-center gap-2">
